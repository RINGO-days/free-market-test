...
## :pushpin:Alpine.jsを利用した支払い方法の選択
- 商品購入画面（purchase/purchase.blade.php）の支払い方法選択時にブラウザのリロードを挟まずに、小計画面の変更が反映される機能を実装
- デフォルトはリロードを挟む機能のままだがbladeファイル内の下部にこの機能のコードをコメントアウトしており、利用する場合はコメントアウトを外す
